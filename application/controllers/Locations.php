...
class Locations extends CI_Controller 
{
    ...
    public function index($limit=0)
    {
        ...
        $total_row = $this->locations_model->record_count();
        ...
        $data['result'] = $this->locations_model->getListLocations($config["per_page"], $offset);
    ...
    public function status()
    {
        ...
        if($this->locations_model->ubahstatus($userid)) {
            echo "success";
        } else {
            echo "error";
        }
