...
{
    function hasil_resume($limit=0,$full_range=false,$created_by=null)
    {
        // Tampilkan hanya user sesuai dengan user operator yang membuatnya
        if($created_by != null) {
            $creator_id = ' and created_by = '. $created_by . ' ';
        } else {
            $creator_id = '';
        }
    ...
    function hasil_list($limit=0,$full_range=false, $created_by=null)
    {
        // Tampilkan hanya user sesuai dengan user operator yang membuatnya
        if($created_by != null) {
            $creator_id = ' and created_by = '. $created_by . ' ';
    ...
    function hasil_tpu_tpa($limit=0,$full_range=false, $created_by=null)
    {
        // Tampilkan hanya user sesuai dengan user operator yang membuatnya
        if($created_by != null) {
            $creator_id = ' and created_by = '. $created_by . ' ';
    ...
    function hasil_disc($limit=0,$full_range=false, $created_by=null)
    {
