						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">	 
									...
									<div class="radio">
										<input type="radio" name="score" id="flat-radio-<?php echo ($key+1);?>" value="<?php echo $key;?>" <?php if($val['score']==1){ echo 'checked'; } ?>>
										<label for="flat-radio-<?php echo ($key+1);?>">Select Correct Option</label>
									</div>
									<br>
