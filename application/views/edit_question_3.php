						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">	 
									...
									<div class="col-md-5">
										<input class="form-control" type="text" name="option[]" value="<?php echo $val['q_option'];?>"  >
									</div>
									<div class="col-md-2">
										<p class="text-center">=</p>
									</div>
									<div class="col-md-5">
										<input class="form-control" type="text" name="option2[]" value="<?php echo $val['q_option_match'];?>"  >
									</div>
								</div>
							</div>
						</div>
