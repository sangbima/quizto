<html lang="en">
    <head>
        ...
        <!--[if lt IE 9]>
        <script src="<?php echo base_url('bootflat/js/html5shiv.js'); ?>"></script>
        <script src="<?php echo base_url('bootflat/js/respond.min.js')?>"></script>
        <![endif]-->
        <!-- custom javascript -->
        ...
        <script type="text/javascript">
          ...
          {
            if (colnum == 0) document.form.Least
              [rownum].checked = false;
            else  document.form.Most
              [rownum].checked = false;
          }
        </script>
    </head>
    ...
    <nav class="navbar navbar-default" role="navigation">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo site_url();?>"><?php echo $this->lang->line('savsoft_quiz');?></a>
            </div>
