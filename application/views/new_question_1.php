						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">	 
									...
									<div class="radio">
										<input type="radio" id="flat-radio-<?php echo $i;?>" name="score" value="<?php echo $i-1;?>" <?php if($i==1){ echo 'checked'; } ?> >
										<label for="flat-radio-<?php echo $i;?>">Select Correct Option</label> 
									</div>
									<br>
