<div class="container">
    ...
    <div class="row">
        <div class="col-lg-6">
            <form method="post" action="<?php echo site_url('user/operator/');?>">
    ...
    <a href="<?php echo site_url('user/operator/'.$back);?>"  class="btn btn-primary"><?php echo $this->lang->line('back');?></a>
    &nbsp;&nbsp;
    <?php
    $next=$limit+($this->config->item('number_of_rows'));  ?>

    <a href="<?php echo site_url('user/operator/'.$next);?>"  class="btn btn-primary"><?php echo $this->lang->line('next');?></a>
