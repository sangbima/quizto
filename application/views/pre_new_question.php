				...
				<div class="panel panel-default">
					<div class="panel-body"> 
						...
						<div class="form-group">	 
							...
							<select class="form-control selecter_4" name="question_type" onChange="hidenop(this.value);">
								...
								<option value="6"><?php echo $this->lang->line('disc_question');?></option>
							</select>
						</div>
						<div class="form-group" id="nop" >	 
							<label for="inputEmail"  ><?php echo $this->lang->line('nop');?></label> 
							<input type="text"   name="nop"  class="form-control" value="5"   >
						</div>
