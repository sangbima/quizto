<div class="container">
	...
	<div class="row">
		<div class="col-md-12">
			...
			?>
			<form class="form-inline" role="form" method="post" action="<?php echo site_url('qbank/pre_question_list/'.$limit.'/'.$cid.'/'.$lid);?>">
				<div class="row">
					<div class="col-md-4">
						<select id="inputcid" name="cid" class=" form-control selecter_4">
					...
					<div class="col-md-4">
						<select  id="inputlid" name="lid" class="form-control selecter_4">
			...
			<table class="table table-bordered">
				...
				<tr>
					...
					<td>
						...
						if($val['question_type']==$this->lang->line('disc_question')){
							$qn=6;
						}
						?>
						<a class="btn btn-primary" href="<?php echo site_url('qbank/edit_question_'.$qn.'/'.$val['qid']);?>"><i class="fa fa-edit"></i></a>
						<a class="btn btn-danger" href="javascript:remove_entry('qbank/remove_question/<?php echo $val['qid'];?>');"><i class="fa fa-trash"></i></a>
					</td>
				</tr>
				<?php 
				}
	...
	<div class="panel panel-default">
		<div class="panel-body">
			<?php echo form_open('qbank/import',array('enctype'=>'multipart/form-data')); ?>
				...
				<div class="row">
					<div class="col-md-6">
						<select name="cid" class="selecter_4">
					...
					<div class="col-md-6">
						<select name="did" class="selecter_4">
