...
<div class="container" >
	...
	<div class="row"  >
 	...
 	<div class="row"  style="margin-top:5px;">
		<div class="col-md-10">
			<form method="post" action="<?php echo site_url('quiz/submit_quiz/'.$quiz['rid']);?>" id="form" name="form">
						...
						<div class="option_container" >
							...
							<table class="table table-bordered">
								...
								<tr>
									<td>
										<div class="radio">
											<input type="radio" name="answer['most'][<?php echo $qk;?>][]" value="<?php echo $exp_opt[0] ?>" onclick="TestCheckMarkQ(<?=$i?>, 0)" />
										</div>
									</td>
									<td>
										<div class="radio">
								 			<input type="radio" name="answer['least'][<?php echo $qk;?>][]" value="<?php echo $exp_opt[1] ?>" onclick="TestCheckMarkQ(<?=$i?>, 1)" />
										</div>
									</td>
									<td>
										<?php echo $exp_opt[2];?>
