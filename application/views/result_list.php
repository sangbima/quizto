<div class="container">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="sr-only" for="inputQuid"><?php echo $this->lang->line('select_quiz');?></label>
                            <select class="form-control selecter_4" id="inputQuid" name="quid">
                     ...
                     <div class="col-md-3">
                        <div class="form-group">
                            <label class="sr-only" for="inputGid"><?php echo $this->lang->line('select_group');?></label>
                            <select class="form-control selecter_4" id="inputGid" name="gid">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label class="sr-only" for="fromDate"><?php echo $this->lang->line('date_from');?></label>
                            <input class="form-control" type="text" id="fromDate" name="date1" value="" placeholder="<?php echo $this->lang->line('date_from');?>">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <label class="sr-only" for="toDate"><?php echo $this->lang->line('date_to');?></label>
                            <input class="form-control" type="text" id="toDate" name="date2" value="" placeholder="<?php echo $this->lang->line('date_to');?>">
                        </div>
                    </div>
                    <div class="col-md-2">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <td>
            <a href="<?php echo site_url('result/view_result/'.$val['rid']);?>" class="btn btn-success" ><i class="fa fa-eye"></i></a>
            <?php 
            if($logged_in['su']=='1'){
            ?>
            <a class="btn btn-danger" href="javascript:remove_entry('result/remove_result/<?php echo $val['rid'];?>');"><i class="fa fa-trash"></i></a>
            <?php 
            }
            ?>
            </td>
