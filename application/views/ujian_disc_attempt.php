    ...
    <div class="row"  style="margin-top:5px;">
        <div class="col-md-10">
            ...
            <form method="post" action="<?php echo site_url('ujian/submit_quiz_disc/'.$quiz['rid']);?>" id="form" name="form">
                ...
                <input type="hidden" name="noq" value="24">
                    ...
                    ?>
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                <h3 class="panel-title">Soal No: <?php echo $key+1 ?></h3>
                            </div>
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" name="no_pernyataan[<?php echo $key ?>]" value="<?php echo $val['no_pernyataan']?>">
                                    </td>
                                </tr>
                                <?php } ?> 
                            </table>
                ...
                <button class="btn btn-danger"  type="submit"><?php echo $this->lang->line('submit_quiz');?></button>
            </form>
