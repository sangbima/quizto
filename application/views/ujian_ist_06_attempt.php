<script>
    ...
    function submitform(){
        alert('Time Over');
        window.location="<?php echo site_url('ujian/submit_quiz_zr/');?>";
    }
</script>
...
<div class="container" >
    ...
    <div class="row"  style="margin-top:5px;">
        <div class="col-md-10">
            <form method="post" action="<?php echo site_url('ujian/submit_quiz_zr()/'.$quiz['rid']);?>" id="form" name="form">
...
<div  id="warning_div" style="padding:10px; position:fixed;z-index:100;display:none;width:100%;border-radius:5px;height:200px; border:1px solid #dddddd;left:4px;top:70px;background:#ffffff;">
    <center><b> <?php echo $this->lang->line('really_Want_to_submit');?></b> <br><br>
        ...
        <a href="javascript:submit_ujian_zr();"   class="btn btn-info"  style="cursor:pointer;"><?php echo $this->lang->line('submit_quiz');?></a>
    </center>
</div>
