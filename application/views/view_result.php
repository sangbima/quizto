			...
			<div class="panel panel-default">
				<div class="panel-body">	 
					<table class="table table-bordered">
						...
						<tr><td><?php echo $this->lang->line('attempt_time');?></td><td><?php echo date('d-m-Y H:i:s',$result['start_time']);?></td></tr>
								...
								<div style="padding:10px;" >
									...
									<?php
										...
										foreach ($correct_options as $key => $value) {
											$correctOptions[$key] = strip_tags($value);
										}

										echo $this->lang->line('correct_options').': '.implode(', ',$correctOptions);
									}
									...
									?>
										<div class="op"> 
											...
											<input type="text" class="form-control" name="answer[<?php echo $qk;?>][]" value="<?php echo $save_ans;?>" id="answer_value<?php echo $qk;?>"   >  
										</div>
									<?php 
										foreach($options as $ok => $option){
											if($option['qid']==$question['qid']){
										...
										<div class="op">
											<table>
												...
												<tr>
													...
													<td>
														<select class="form-control selecter_4" name="answer[<?php echo $qk;?>][]" id="answer_value<?php echo $qk.'-'.$mk1;?>"  >
